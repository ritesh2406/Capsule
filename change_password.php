				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="Update_Pass.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Old Password </label>

										<div class="col-sm-9">
											<input type="password" id="form-field-1" placeholder="Old Password" class="col-xs-10 col-sm-5" name="oldpassword"/>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> New Password </label>

										<div class="col-sm-9">
											<input type="password" id="form-field-2" placeholder="New Password" class="form-control" name="newpassword"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Confirm New Password </label>

										<div class="col-sm-9">
											<input type="password" id="form-field-3" placeholder="Confirm New Password" class="col-xs-10 col-sm-5" name="cpassword"/>
											<!--<span class="help-inline col-xs-12 col-sm-7">-->
												<!--<span class="middle">Inline help text</span>-->
											<!--</span>-->
                                            <!--<textarea class="form-control" id="form-field-8" placeholder="Default Text" width="50" height="50"></textarea>-->
                                        </div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
                                            ...
                                            <input type="submit" name="submit" class="btn btn-info" value="submit" onclick="return confirpassword_validate()">
...
<![endif]-->
		...
		function confirpassword_validate(){
			
			var old_password=document.getElementById("form-field-1").value;
			var new_password=document.getElementById("form-field-2").value;
			var confirm_password=document.getElementById("form-field-3").value;
