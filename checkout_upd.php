...
if($_POST){
   ...
   // $cust_id=mysqli_insert_id($con);
    ...
    $n="select * from customers where email='".$_SESSION['email']."'";
    $m=mysqli_query($con,$n);
         
	$b=mysqli_fetch_array($m);
	$insert="insert into orders(order_date,total_amount,cust_id)values('$date','".$_SESSION['grand_total']."','".$b['cust_id']."')";
   ...
   $cart="select * from cart where session_id='".session_id()."'";
    ...
    //$query1=mysqli_query($con,$orders);
     ...
     while($fetch=mysqli_fetch_array($query)){
        ...
        header('location:payment.php?order_id='.$order.'&total_amount='.$_SESSION['grand_total']);
							...
							<p>Bill To</p>
								...
								<!--<form method="post" action="insert.php">-->
									...
									<input type="text" name="bill_lname" placeholder="Last Name *" id="bill_lname"
                                           value="<?php echo $f['bill_lname']; ?>">
                                    <input type="text" name="bill_mobile" placeholder="Phone *" id="bill_mobile"
                                           value="<?php echo $f['bill_mobile']; ?>">
									<input type="text" name="bill_address" placeholder="Address *" id="bill_address"
                                           value="<?php echo $f['bill_address']; ?>">
									<!--<input type="text" placeholder="Address 2">-->
								
									<input type="text" name="bill_pincode" placeholder="Zip / Postal Code *" id="bill_pincode" value="<?php echo $f['bill_pincode']; ?>">
									<select name="bill_country" id="bill_country" value="<?php echo $f['bill_country']; ?>">
                                        <option value="<?php echo $f['bill_country']; ?>" ><?php echo $f['bill_country']; ?></option>
									...
									<select name="bill_city" id="bill_city" value="<?php echo $f['bill_city']; ?>">
                                        <option value="<?php echo $f['bill_city']; ?>" ><?php echo $f['bill_city']; ?></option>
                                    ...
                                    <input type="text" name="email" placeholder="Email*" id="email" onBlur="checkAvailability()" value="<?php echo $f['email']; ?>">
                            ...
                            <div class="form-two">
								<!--<form method="post" action=" ">-->
									...
									<input type="text" name="ship_fname" placeholder="First Name *" id="ship_fname"
                                           value="<?php echo $f['ship_fname']; ?>">
									<!--<input type="text" name="bill_midname" placeholder="Middle Name">-->
									<input type="text" name="ship_lname" placeholder="Last Name *" id="ship_lname"
                                           value="<?php echo $f['ship_lname']; ?>">
                                    <input type="text" name="ship_mobile" placeholder="Phone *" id="ship_mobile"
                                           value="<?php echo $f['ship_mobile']; ?>">
									<input type="text" name="ship_address" placeholder="Address *" id="ship_address"
                                           value="<?php echo $f['ship_address']; ?>">
									<!--<input type="text" placeholder="Address 2">-->
								    <input type="text" name="ship_pincode" placeholder="Zip / Postal Code *" id="ship_pincode" value="<?php echo $f['ship_pincode']; ?>">
									<select name="ship_country" id="ship_country" value="<?php echo $f['ship_country']; ?>">
                                        <option value="<?php echo $f['ship_country']; ?>" ><?php echo $f['ship_country']; ?></option>
										<option>-- Country --</option>
										<option>United States</option>
										<option>Bangladesh</option>
										<option>UK</option>
									...
									<select name="ship_city" id="ship_city" value="<?php echo $f['ship_city']; ?>">
                                        <option value="<?php echo $f['ship_city']; ?>" ><?php echo $f['ship_city']; ?></option>
										<option>-- State / Province / Region --</option>
										<option>Kolkata</option>
										<option>Banglore</option>
										<option>Mumbai</option>
