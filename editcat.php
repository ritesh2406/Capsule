...
<html lang="en">
	...
	<body class="no-skin">
        ...
        //exit();
         $sel="SELECT * FROM category_tbl WHERE `category_tbl`.`catid` = '".$_GET['id']."'";
						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <?php 
                                       ...
                                       ?>
								<form class="form-horizontal" role="form" method="post" action="cat_edit_action.php" enctype="multipart/form-data">
								...
								<!--<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Parent Category </label>-->
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Add Category </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="Add Category" name="addcategory" class="form-control" value="<?php echo $rows['category_name'];?>"/>
                                            <input type="text" name="id" value="<?php echo $rows['catid'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Category Description </label>
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="categorydescription" id="form-field-8" placeholder="Default Text" width="50" height="50"><?php echo $rows['category_descc'];?></textarea>
                                        </div>
									</div>
									...
									<div class="space-4">
                                      ...
                                      <input type="hidden" name="imgname"  value="<?php echo $rows['category_img'];?>">
                                    </div>
...
<![endif]-->
		...
		function cat_validate(){
			...
			var addcategory=document.getElementById("form-field-2").value;
			var categorydescription=document.getElementById("form-field-8").value;
			...
			/*if(parentcategory== "" || parentcategory== null){
             ...
             if(addcategory== "" || addcategory== null){
              ...
              else if(categorydescription== "" || categorydescription== null){
