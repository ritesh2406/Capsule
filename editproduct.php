...
<html lang="en">
	...
	<body class="no-skin">
       ...
       //exit();
         $sel="SELECT * FROM prod_tbl WHERE `prod_tbl`.`productid` = '".$_GET['id']."'";
        ...
        ?>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="edit_prod_action.php" enctype="multipart/form-data">
								<?php
								...
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Parent Category </label>
										...
										<div class="col-sm-9">
                                            <select name="parent_id" id="form-field-1">
                                                ...
                                                <?php //if($rows['catid']==$row['catid']){?>
                                                <option value="<?php //echo $row['catid'];?>" selected="selected"><?php //echo $row['category_name'];?></option>
                                                <?php //} //else { ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        <input type="text" id="form-field-2" placeholder="Add Product Name" name="prodname" class="form-control" value="<?php echo $rows['prod_name'];?>" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="proddescc" id="form-field-8" placeholder="Default Text" width="50" height="50"><?php echo $rows['prod_descc']; ?></textarea>
                                        </div>
									</div>

									<div class="space-4">
                                     <input type="hidden" name="imgname"  value="<?php echo $rows['prod_image'];?>">
                                    </div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> Product Image </label>

										<div class="col-sm-9">
											<label class="btn btn-default btn-file">
                                           <input type="file" name="img" value="<?php echo $rows['prod_image']; ?>">
                                           </label>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        <input class="input-sm" type="number" id="form-field-4" placeholder="Product Price" name="price"  value="<?php echo $rows['prod_price']; ?>"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-5">Product Colour</label>

										<div class="col-sm-9">
											<div class="clearfix">
                                            <input class="input-sm" type="text" id="form-field-5" placeholder="Product Color" name="color" value="<?php echo $rows['color']; ?>"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Product Size</label>

										<div class="col-sm-9">
                                        <input class="input-sm" type="text" id="form-field-6" placeholder="Product Size" name="size"  value="<?php echo $rows['size']; ?>"/>(Example:S,M,L,XL,XXL)
                                        </div>
                                        <div class="space-2"></div>
                                     </div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-6">Stock Quantity</label>

										<div class="col-sm-9">
                                        <input class="input-sm" type="number" id="form-field-7" placeholder="Stock Quantity" name="stock" value="<?php echo $rows['stock']; ?>"/>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">Featured</label>

										<div class="col-sm-9">
											<div class="inline">
                                                     <input class="input-sm" type="text" id="form-field-f" placeholder="Featured" name="featured" value="<?php echo $rows['featured']; ?>"/><br><br>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">Recommended</label>

										<div class="col-sm-9">
											<div class="inline">
                                                <input class="input-sm" type="text" id="form-field-r" placeholder="Recommended" name="recommended" value="<?php echo $rows['recommended']; ?>"/><br><br>
												<!--<input type="text" name="tags" id="form-field-tags" value="Tag Input Control" placeholder="Enter tags ..." />-->
											</div>
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
                                            ...
                                            <input type="submit" name="submit" class="btn btn-info" value="submit" onclick="return cat_validate()">
									...
									<!--<div class="row">
										<div class="col-xs-12 col-sm-5">
											<div class="control-group">
												...
												<div class="checkbox">
													<label class="block">
														<input name="form-field-checkbox" disabled="" type="checkbox" class="ace" />F
...
<![endif]-->
		...
		function cat_validate(){
			...
			var parentcategory=document.getElementById("form-field-1").value;
			var prodname=document.getElementById("form-field-2").value;
			var proddescc=document.getElementById("form-field-8").value;
            var prodprice=document.getElementById("form-field-4").value;
            var prodcolor=document.getElementById("form-field-5").value;
            var prodsize=document.getElementById("form-field-6").value;
            var prodstock=document.getElementById("form-field-7").value;
			...
			if(parentcategory== "" || parentcategory== null){
              ...
              else if(proddescc== "" || proddescc== null){
			  alert("Please enter product description");
               return false;
			}				
				else if(prodprice== "" || prodprice== null){
			  alert("Please enter product price");
               return false;		
                }
            else if(prodcolor== "" || prodcolor== null){
			  alert("Please enter product color");
               return false;
            }
            else if(prodsize== "" || prodsize== null){
			  alert("Please enter product size");
               return false;
            }
            else if(prodstock== "" || prodstock== null){
