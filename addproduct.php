				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="insert1.php" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Parent Category </label>

										<div class="col-sm-9">
                                            <select name="parent_category" id="form-field-1" >
                                                <option value ="0">Parent Category</option>";
                                                 <?php while($rows=mysqli_fetch_assoc($res)):?>
                                                <option value="<?php echo $rows['catid'];?>"><?php echo $rows['category_name'];?></option>
                                                <?php endwhile; ?>
                                              </select>
											<!--<input type="text" id="form-field-1" placeholder="Parent Category" name="parent category" class="col-xs-10 col-sm-5" />-->
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="Add Product Name" name="prodname" class="form-control" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="proddescc" id="form-field-8" placeholder="Default Text" width="50" height="50"></textarea>
                                        </div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> Category Image </label>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="input-sm" type="number" id="form-field-4" placeholder="Product Price" name="price" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="clearfix">
												<input class="input-sm" type="text" id="form-field-5" placeholder="Product Color" name="color" />(Example: red,blue,green)
											</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="input-sm" type="text" id="form-field-6" placeholder="Product Size" name="size" />(Example:S,M,L,XL,XXL)
                                        </div>
                                        <div class="space-2"></div>
                                     </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="input-sm" type="number" id="form-field-7" placeholder="Stock Quantity" name="stock" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="inline">
												Featured:<input type="radio" name="featured" id="form-field-f" value="featured" /><br>
                                                Non Featured:<input type="radio" name="nonfeatured" id="form-field-nf" value="non-featured" />
											</div>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<div class="inline">
												Recommended:<input type="radio" name="recommended" id="form-field-r" value="recommended" /><br>
                                                Non Recommended:<input type="radio" name="nonrecommended" id="form-field-nr" value="non-recommended" />
											</div>
										</div>
									</div>
