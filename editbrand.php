...
<html lang="en">
	...
	<body class="no-skin">
        ...
        //exit();
         $sel="SELECT * FROM brand_tbl WHERE `brand_tbl`.`brand_id` = '".$_GET['id']."'";
						...
						<div class="row">
							<div class="col-xs-12">
                                ...
                                <?php 
                                       ...
                                       ?>
								<form class="form-horizontal" role="form" method="post" action="brand_edit_action.php" enctype="multipart/form-data">
								...
								<!--<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Parent Category </label>-->
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Add Brand </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="Add Brand" name="addbrand" class="form-control" value="<?php echo $rows['bname'];?>"/>
                                            <input type="text" name="id" value="<?php echo $rows['brand_id'];?>">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Brand Description </label>
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="branddescription" id="form-field-8" placeholder="Default Text" width="50" height="50"><?php echo $rows['bdescc'];?></textarea>
                                        </div>
									</div>
									...
									<div class="space-4">
                                      ...
                                      <input type="hidden" name="imgname"  value="<?php echo $rows['bimg'];?>">
                                    </div>

									<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> Brand Image </label>
...
<![endif]-->
		...
		function cat_validate(){
			...
			var addbrand=document.getElementById("form-field-2").value;
			var branddescription=document.getElementById("form-field-8").value;
			...
			/*if(parentcategory== "" || parentcategory== null){
             ...
             if(addbrand== "" || addbrand== null){
			  alert("Please enter add brand");
               return false;
			}
              else if(branddescription== "" || branddescription== null){
