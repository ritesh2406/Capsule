				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="insert.php" enctype="multipart/form-data">
...
function RecursiveCat($parent_id)
{
	static $level=0;
	static $strid="";
	static $strname="";
	global $obj;
	 ...
	 $where ="WHERE catid = ".$parent_id;
	 $rs = $obj->getList('category_name',$where);
...
foreach ($rs as $row) {
		...
		$strname.='<option value="'.$row['id'].'">'.$pad.$row['category_name'].'</option>';
		$rid=RecursiveCat($id);
		$strid[]=$row['id'];
		$level++;
...
?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="Add Category" name="addcategory" class="form-control" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="categorydescription" id="form-field-8" placeholder="Default Text" width="50" height="50"></textarea>
                                        </div>
									</div>
...
<![endif]-->
		...
		function cat_validate(){
			...
			if(parentcategory== "" || parentcategory== null){
              ...
              else if(addcategory== "" || addcategory== null){
