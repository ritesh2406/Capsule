				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" method="post" action="insertb.php" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            <select name="parent_category">
                                                ...
                                                <option value="<?php echo $rows['brand_id'];?>"><?php echo $rows['category_name'];?></option>
                                                <?php endwhile; ?>
                                              </select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="Add Brand" name="addbrand" class="form-control" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                            ...
                                            <textarea class="form-control" name="branddescription" id="form-field-8" placeholder="Default Text" width="50" height="50"></textarea>
                                        </div>
									</div>
...
<![endif]-->
		...
		function cat_validate(){
			...
			if(parentcategory== "" || parentcategory== null){
              ...
              else if(addbrand== "" || addbrand== null){
